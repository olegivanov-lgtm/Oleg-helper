...
For RECTANGLE:
{"shape": "rectangle", "unit": "m", "sides": {"length": 5.2, "width": 3.1}}

For TRIANGLE:
{"shape": "triangle", "unit": "m", "sides": {"base": 4.0, "height": 3.0, "side_a": 4.0, "side_b": 3.0, "side_c": 5.0}}

For L-SHAPE:
{"shape": "l_shape", "unit": "m", "rect1": {"length": 5.0, "width": 3.0}, "rect2": {"length": 2.0, "width": 2.0}}

For TRAPEZOID:
{"shape": "trapezoid", "unit": "m", "sides": {"top": 3.0, "bottom": 5.0, "height": 4.0, "left": 4.1, "right": 4.1}}

For CIRCLE:
{"shape": "circle", "unit": "m", "radius": 2.5}

For ANY IRREGULAR POLYGON (use this when the shape doesn't fit the above):
{"shape": "polygon", "unit": "m", "vertices": [[0,0], [5,0], [5,3], [3,3], [3,5], [0,5]]}
